...
// v4 uses: VISION_EXPORT_SWIFT_FRAME_PROCESSOR(ClassName, "jsMethodName")
// - No @interface wrapper needed
// - Method name is a STRING in quotes
...
// Import Swift bridging header - Expo uses the app name as prefix
